...
- **Risk** — Open storage is one of the top causes of cloud data breaches. One “allow public read” or exposed key can expose entire datasets.
- **Compliance** — UK GDPR and sector rules require appropriate technical and organisational measures. Public blob access with personal data is hard to justify and attracts regulatory attention.
